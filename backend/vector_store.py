...
class RAGSystem:
    ...
    def generate_context(self, query: str, max_context_length: int = 2000) -> str:
        ...
        context_parts = ["Here's relevant information from the GitHub repository:"]
    ...
    def query_with_context(self, user_query: str) -> Dict[str, str]:
        ...
        vulnerable_prompt = f"""You are a helpful assistant answering questions about a GitHub repository.

Context from repository discussions:
{context}
