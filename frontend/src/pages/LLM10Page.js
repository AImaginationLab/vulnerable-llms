...
const LLM10Page = () => {
  ...
  return (
    <div className="container">
      <h1>LLM10:2025 Unbounded Consumption</h1>
      
      <div className="demo-section">
        <h3>📖 Overview</h3>
        <p>
          Unbounded Consumption occurs when LLM applications allow users to consume excessive computational 
          resources through very large, complex, or numerous requests. This can lead to denial of service, 
          increased costs, degraded performance for other users, and potential system instability.
        </p>
      </div>

      <div className="demo-section">
        <h3>🎭 Demo Scenario: Resource Exhaustion Attack</h3>
        <p>
          In this demo, we'll send resource-intensive prompts to the local LLM and measure the response 
          time and computational impact. This demonstrates how attackers could potentially overwhelm 
          LLM services with computationally expensive requests.
        </p>
      </div>
      ...
      <div className="demo-section">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px', marginBottom: '20px' }}>
          ...
          <button 
            ...
            disabled={loading}
            style={{ padding: '16px', fontSize: '14px', background: '#28a745' }}
          >
            📊 Run Comparison Test
          </button>
        </div>
        ...
        {isRunning && (
          <div className="timer">
            ⏱️ Processing Time: {formatTime(timer)}
          </div>
        )}
            ...
            {result.error ? (
              ...
              <>
                ...
                {result.response_time_ms > 5000 && (
                  <div className="alert-danger">
                    <strong>⚠️ Resource Exhaustion Detected!</strong> This request took significantly longer 
                    than normal, demonstrating how resource-intensive prompts can impact system performance 
                    and potentially deny service to other users.
                  </div>
                )}
              </>
            )}
      ...
      <div className="demo-section">
        ...
        <ul>
          <li><strong>Rate Limiting:</strong> Implement per-user and per-IP request limits</li>
          <li><strong>Input Length Limits:</strong> Restrict maximum prompt length and complexity</li>
          <li><strong>Response Length Limits:</strong> Cap the maximum length of generated responses</li>
          <li><strong>Timeout Controls:</strong> Set maximum processing time for requests</li>
          <li><strong>Resource Monitoring:</strong> Monitor CPU, memory, and processing time usage</li>
          <li><strong>Queue Management:</strong> Implement fair queuing to prevent resource monopolization</li>
          <li><strong>Authentication:</strong> Require user authentication to enable tracking and limits</li>
          <li><strong>Cost Controls:</strong> Set budget limits and alerts for computational spending</li>
          <li><strong>Load Balancing:</strong> Distribute requests across multiple instances</li>
          <li><strong>Caching:</strong> Cache responses to reduce repeated computation</li>
        </ul>
      </div>
    </div>
  );
